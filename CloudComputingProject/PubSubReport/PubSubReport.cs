...
namespace PubSubReport
{
    ...
    /// </summary>
    internal sealed class PubSubReport : StatefulService
    {
        PubSubService pubSubService;

        public PubSubReport(StatefulServiceContext context)
            : base(context)
        {
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            var ActiveData = await this.StateManager.GetOrAddAsync<IReliableDictionary<string, PlannedWork>>("ActiveData");
            var HistoryData = await this.StateManager.GetOrAddAsync<IReliableDictionary<string, PlannedWork>>("HistoryData");
